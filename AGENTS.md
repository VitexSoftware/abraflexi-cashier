# AGENTS.md - Working AI Reference for abraflexi-cashier

## Project Overview
**Type**: PHP Project/Debian Package
**Purpose**: ![Cashier](abraflexi-cashier.svg?raw=true)
**Status**: Active
**Repository**: git@github.com:VitexSoftware/abraflexi-cashier.git
...
git clone git@github.com:VitexSoftware/abraflexi-cashier.git
